...
import { Calendar, Search, Bell, Shield } from "lucide-react";
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-[14px] leading-[1.7] text-text-secondary max-w-[340px] md:pb-1 font-medium">
            A centralized platform for discovering hackathons, internships, and
            tech opportunities. Built to help students track events, set
            reminders, and stay updated in one place.
          </p>
        </motion.div>
        ...
        <div className="border border-border-color rounded-2xl overflow-hidden bg-card-bg shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="lg:col-span-7 p-8 md:p-12 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-border-color">
              <div>
                ...
                <h3 className="text-[28px] md:text-[34px] font-black tracking-tight text-text-primary mb-4">
                  Ignita — Student Event Aggregator
                </h3>
                <p className="text-[15px] leading-[1.7] text-text-secondary font-medium mb-8">
                  Building the Ultimate Tech Opportunity Hub with a a Smarter
                  ...
                  {[
                    {
                      ...
                      desc: "Discover hackathons, internships, coding contests, and workshops from one platform.",
                    },
                    {
                      icon: Search,
                      title: "Smart Search & Filters",
                      desc: "Find opportunities based on category, mode, and interests.",
                    },
                    {
                      icon: Bell,
                      title: "Alerts & Notifications",
                      desc: "Get reminders for bookmarked events and important deadlines.",
                    },
                    {
                      icon: Shield,
                      title: "Admin Dashboard",
                      desc: "Manage events, users, alerts, analytics, and platform content.",
                    },
                  ].map((sub, i) => (
                    <div key={i} className="flex gap-3 items-start">
                      ...
                      <div>
                        <h4 className="text-[12px] font-black text-text-primary uppercase leading-tight">
                          {sub.title}
                        </h4>
              ...
              <div className="flex items-center gap-4 pt-6 border-t border-border-color/60">
                ...
                <a
                  href="https://github.com/snehapal/ignita"
                  target="_blank"
            ...
            <div className="lg:col-span-5 p-8 md:p-12 bg-bg-secondary/20 flex flex-col justify-between">
              <div>
                <span className="text-[9px] font-black tracking-widest text-text-secondary uppercase block mb-6">
                  SPRINT METRICS
                </span>
                ...
                <div className="flex flex-col gap-3">
                  {[
                    {
                      task: "AST Symbol Context Retrieval",
                      status: "completed",
                      percent: 100,
                    },
                    {
                      task: "Self-Correction Backtracking Memory",
                      status: "completed",
                      percent: 100,
                    },
                    {
                      task: "Dockerized Sandbox Isolation",
                      status: "active",
                      percent: 70,
                    },
                    {
                      task: "Interactive Goal Palette dashboard",
                      status: "queued",
                      percent: 0,
                    },
                  ].map((item, idx) => (
                    <div
                      key={idx}
                      className="border border-border-color rounded-xl p-3 bg-bg-primary flex items-center justify-between"
                    >
                      ...
                      <span
                        className={`text-[10px] font-mono font-bold px-1.5 py-0.5 rounded ${
                          item.status === "completed"
                            ...
                            : item.status === "active"
                              ? "bg-accent-color/15 text-accent-color animate-pulse"
