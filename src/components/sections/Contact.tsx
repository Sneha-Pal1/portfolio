...
const socials = [
  { label: "GitHub", href: "https://github.com/Sneha-Pal1", icon: GithubIcon },
  // { label: "Twitter", href: "https://twitter.com/snehapal", icon: TwitterIcon },
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/sneha-pal-54669428a/",
    icon: LinkedinIcon,
  },
];
...
export default function Contact() {
  return (
    <section
      id="contact"
      className="w-full border-t border-border-color bg-bg-primary relative overflow-hidden"
    >
      {/* Mountain backdrop */}
      <div className="absolute inset-0 pointer-events-none select-none opacity-[0.08] dark:opacity-[0.04]">
        ...
        >
          <path
            d="M0,500 L0,300 L120,200 L260,280 L420,130 L580,220 L740,70 L920,170 L1080,90 L1240,180 L1400,130 L1400,500 Z"
            fill="rgba(var(--mountain-2),0.5)"
          />
          <path
            d="M0,500 L0,380 L180,270 L360,360 L560,240 L760,330 L960,260 L1160,340 L1400,290 L1400,500 Z"
            fill="rgba(var(--mountain-3),0.55)"
          />
          <path
            d="M0,500 L0,440 L200,370 L440,430 L680,360 L920,420 L1160,370 L1400,400 L1400,500 Z"
            fill="rgba(var(--mountain-4),0.5)"
          />
        </svg>
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-8 md:px-10 pt-28 pb-20">
        ...
        >
          <span className="text-[10px] font-black tracking-[0.2em] text-accent-color block mb-6 uppercase">
            CONTACT
          </span>

          <h2
            className="font-black leading-[1.0] tracking-[-0.04em] mb-6 text-text-primary"
            style={{
          ...
          <p className="text-[17px] leading-[1.65] text-text-secondary max-w-[480px] mb-10 font-medium">
            I&apos;m currently open to software engineering internships, backend
            architecture roles, and open-source collaborations.
          </p>
