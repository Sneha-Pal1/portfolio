...
const jobs = [
  {
    ...
    role: "AI/ML Intern",
    period: "22026 June — Present", // Wait, the user prompt says: "2026 June - present"
  ...
  },
  {
    ...
    periodDisplay: "May 2024 — July 2024 // June 2025 — July 2025",
...
export default function Experience() {
  return (
    <section id="experience" className="w-full border-t border-border-color bg-bg-primary py-24 px-8 md:px-10">
      <div className="max-w-[1400px] mx-auto">
        <motion.div
          ...
          className="mb-14"
        >
          <span className="text-[10px] font-black tracking-[0.2em] text-accent-color block mb-4 uppercase">EXPERIENCE</span>
          ...
          {jobs.map((job, i) => (
            ...
            >
              ...
              <div className="md:w-[200px] flex-shrink-0 flex md:flex-col md:items-end gap-3 md:gap-1 md:pr-10">
                <span className={`text-[11px] font-black tracking-[0.1em] ${job.current ? "text-accent-color" : "text-text-secondary/60"}`}>
                  {job.periodDisplay}
                </span>
                {job.current && (
              ...
              <div className="flex-1 md:pl-10 relative">
                ...
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-[20px] md:text-[23px] font-black tracking-[-0.02em] text-text-primary leading-tight">{job.company}</h3>
                    <p className="text-[13px] text-text-secondary font-semibold mt-0.5">{job.role}</p>
                  </div>
                </div>

                <p className="text-[14px] leading-[1.7] text-text-secondary max-w-[620px] mb-4 font-medium">{job.desc}</p>
