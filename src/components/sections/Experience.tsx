...
const jobs = [
  ...
  },
  {
    ...
    desc: "Contributed to the development of a digital government platform for Self-Help Group (SHG) operations.",
    responsibilities: [
      "Architected and developed scalable REST APIs using NestJS",
  ...
  },
  {
    ...
    periodDisplay: "June 2024 — September 2024",
    desc: "Developed a real-time chatting application using Firebase.",
    responsibilities: [
