    ...
    <div className="bg-bg-primary text-text-primary min-h-screen flex flex-col overflow-hidden print:bg-white print:text-black">
      ...
      <main className="pt-40 pb-24 px-8 md:px-10 flex-1 max-w-[1000px] mx-auto w-full print:pt-0 print:pb-0">
        ...
        <div className="flex justify-between items-center mb-12 pb-6 border-b border-border-color print:hidden">
          <div>
            <span className="text-[10px] font-black tracking-widest text-text-secondary uppercase block mb-1">
              CURRICULUM VITAE
            </span>
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:justify-between items-start gap-6 pb-8 border-b border-border-color/60">
            <div>
              <h2 className="text-[36px] font-black tracking-tight text-text-primary leading-none">
                Sneha Pal
              </h2>
              <p className="text-[15px] font-semibold text-accent-color mt-2">
                B.Tech Computer Science &amp; Engineering Student
              </p>
              <p className="text-[13px] text-text-secondary mt-1 font-medium"></p>
            </div>
            <div className="flex flex-col gap-1 text-[12px] font-semibold text-text-secondary md:items-end">
              {/* <span>xsnehapal@gmail.com</span> */}
              {/* <span>https://github.com/Sneha-Pal1</span>
              <span>https://www.linkedin.com/in/sneha-pal-54669428a/</span> */}
            ...
            <div className="md:col-span-8 flex flex-col gap-10">
              ...
              <div>
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <h3 className="text-[16px] font-black tracking-widest text-text-primary uppercase">
                    Education
                  </h3>
                </div>
                <div className="flex flex-col gap-6 pl-4 border-l-2 border-border-color">
                  <div>
                    ...
                    <p className="text-[13px] font-semibold text-accent-color mt-0.5"></p>
              ...
              <div>
                ...
                <div className="flex flex-col gap-8 pl-4 border-l-2 border-border-color">
                  ...
                  <div>
                    ...
                    <p className="text-[13px] font-semibold text-accent-color mt-0.5">
                      IIIT Kalyani
                    </p>
                    <ul className="list-disc list-inside text-[12px] text-text-secondary mt-2 flex flex-col gap-1 pl-1 font-medium">
                      <li>
                        ...
                        projects as part of internship.
                      </li>
                      <li>
                        Explored Machine Learning workflows, NLP-related tasks,
                        and model experimentation.
                      </li>
                      <li>
                        Conducted research, data preprocessing, model testing,
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside text-[12px] text-text-secondary mt-2 flex flex-col gap-1 pl-1 font-medium">
                      <li>
                        Contributed to a government-backed platform to
                        streamline data operations for Self Help Groups (SHGs).
                      </li>
                      <li>
                        Developed and maintained backend APIs using NestJS,
                        TypeORM, and PostgreSQL for SHG-based e-commerce
                        platform.
                      </li>
                      <li>
                        Implemented authentication and authorization services,
                  ...
                  <div>
                    ...
                    <p className="text-[13px] font-semibold text-accent-color mt-0.5">
                      Directorate of Information Technology (DIT), Agartala
                    </p>
                    <ul className="list-disc list-inside text-[12px] text-text-secondary mt-2 flex flex-col gap-1 pl-1 font-medium">
                      <li>
                        Built and enhanced MERN-based web applications, focusing
                        on backend integration.
                      </li>
                      <li>
                        Worked with React, Node.js, Express, and MongoDB to
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside text-[12px] text-text-secondary mt-2 flex flex-col gap-1 pl-1 font-medium">
                      <li>Developed a real-time chatting application.</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div className="md:col-span-4 flex flex-col gap-10">
              ...
              <div>
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <h3 className="text-[15px] font-black tracking-widest text-text-primary uppercase">
                    Technical Skills
                  </h3>
                </div>
                <div className="flex flex-col gap-5 pl-2">
                  <div>
                    <span className="text-[10px] font-black text-text-secondary uppercase block mb-1.5">
                      Languages
                    </span>
                    <div className="flex flex-wrap gap-1">
                      {["Python", "TypeScript", "JavaScript", "C++", "SQL"].map(
                        (s) => (
                          <span
                            key={s}
                            className="text-[10px] font-bold px-2 py-0.5 bg-bg-secondary text-text-primary rounded"
                          >
                            {s}
                          </span>
                        ),
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {["Next.js", "React", "Tailwind CSS", "HTML5/CSS3"].map(
                        (s) => (
                          <span
                            key={s}
                            className="text-[10px] font-bold px-2 py-0.5 bg-bg-secondary text-text-primary rounded"
              ...
              <div>
                ...
                <div className="flex flex-col gap-4 pl-4 border-l border-border-color text-[12px] font-medium text-text-secondary">
                  <div>
                    ...
                    <p className="mt-0.5">
                      Solved 300+ problems, active participant in bi-weekly
                      contests.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="mt-0.5">
                      Active contributions to tooling repositories and AI
                      planner frameworks.
                    </p>
                  </div>
                </div>
